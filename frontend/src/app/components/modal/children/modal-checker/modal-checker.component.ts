...
@Component({
  selector: 'div[data-app-modal-checker]',
  templateUrl: './modal-checker.component.html',
  styleUrls: ['./modal-checker.component.css']
})
export class ModalCheckerComponent implements OnInit {

  modal: ModalType = 'account-checker-tiny'
  ...
  ngOnInit(): void {
    if(this.params.type == "account-checker-tiny") {
      if(
