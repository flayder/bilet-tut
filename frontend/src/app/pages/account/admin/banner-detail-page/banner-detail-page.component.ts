...
@Component({
  selector: 'app-banner-detail-page',
  templateUrl: './banner-detail-page.component.html',
  styleUrls: ['./banner-detail-page.component.css']
})
export class BannerDetailPageComponent implements AfterContentInit {
